...
public class MainView extends View {
    ...
    //Assets
    private Drawable backgroundControl;
    ...
    public MainView(Context context,int type,int newgame) {
        super(context);
        this.type = type;
        //Loading resources
        ...
        try {
            ...
            backgroundControl = getDrawable(R.drawable.background_control);
    ...
    private void drawScoreText(Canvas canvas) {
        ...
        backgroundControl.setBounds(sXHighScore, sYAll, eXHighScore, eYAll);
        backgroundControl.draw(canvas);
        ...
        backgroundControl.setBounds(sXScore, sYAll, eXScore, eYAll);
        backgroundControl.draw(canvas);
        paint.setTextSize(titleTextSize);
        paint.setColor(getResources().getColor(R.color.text_brown));
    ...
    private void getLayout(int width, int height) {
        ...
        sXHome = sXUndo - iconSize - iconPaddingSize;
        resyncTime();
    }
